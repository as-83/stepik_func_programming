...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.thenApply(createDigest).thenApply(wrapInRequestTag);// !!! write a combination of existing handlers here
    ...
    interface RequestHandler {
        ...
        default RequestHandler thenApply(RequestHandler requestHandler) {
